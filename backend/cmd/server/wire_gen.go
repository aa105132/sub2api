...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountHandler := admin.NewAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, settingService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator)
	...
	openAIChatGPTTeamService := service.NewOpenAIChatGPTTeamService(accountRepository, openAIOAuthService)
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, openAIChatGPTTeamService, httpUpstream, deferredService, openAITokenProvider)
	codexExternalService := service.NewCodexExternalService(configConfig, adminService, accountRepository, openAIOAuthService, openAIChatGPTTeamService)
	...
	externalCodexHandler := handler.NewExternalCodexHandler(codexExternalService)
